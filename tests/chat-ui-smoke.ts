...
try{
 ...
 await page.goto(base+'/demo');await page.getByRole('button',{name:'Start Assessment'}).click();const scroll=page.getByTestId('copilot-scroll');await scroll.waitFor();
 ...
 await page.waitForTimeout(500);assert.ok(await scroll.evaluate(el=>el.scrollHeight-el.scrollTop-el.clientHeight<60));
