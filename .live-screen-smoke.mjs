...
try{
 ...
 for(const [track,actions] of cases){
  ...
  await command(s,'data-handling',{dataHandling:rows});assert.ok(s.state.dataHandling);assert.equal(s.state.track.exhibits.length,0);
 }
