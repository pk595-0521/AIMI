...
export function evaluationEvidence(s:any) {
 ...
 add('hygiene','Passed Data Hygiene Gate',s.dataHandling?'observed':'missing',s.dataHandling?'Server validated every governed field.':'No successful handling submission.');
